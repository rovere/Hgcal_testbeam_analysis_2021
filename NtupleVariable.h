...
// found on file: /eos/user/k/kalpana/flatEnergy_pions/CleanedNtuples/skimmed_ntuple_sim_config22_pions_0to1M_combinedHgc_Ahc_v46.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/user/k/kalpana/flatEnergy_pions/CleanedNtuples/skimmed_ntuple_sim_config22_pions_0to1M_combinedHgc_Ahc_v46.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/user/k/kalpana/flatEnergy_pions/CleanedNtuples/skimmed_ntuple_sim_config22_pions_0to1M_combinedHgc_Ahc_v46.root");
      }
...
void NtupleVariable::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("combined_NRechits", &combined_NRechits, &b_combined_NRechits);
   fChain->SetBranchAddress("combined_rechits_energy", &combined_rechits_energy, &b_combined_rechits_energy);
   fChain->SetBranchAddress("combined_rechit_x", &combined_rechit_x, &b_combined_rechit_x);
   fChain->SetBranchAddress("combined_rechit_y", &combined_rechit_y, &b_combined_rechit_y);
   fChain->SetBranchAddress("combined_rechit_z", &combined_rechit_z, &b_combined_rechit_z);
   ...
   fChain->SetBranchAddress("ahc_nHits_orig", &ahc_nHits_orig, &b_ahc_nHits_orig);
...
//    fChain->SetBranchAddress("comb_rechit_z_trimAhcal", &comb_rechit_z_trimAhcal, &b_comb_rechit_z_trimAhcal);
   ...
   fChain->SetBranchAddress("lambda_trimAhcal", &lambda_trimAhcal, &b_lambda_trimAhcal);
   fChain->SetBranchAddress("lambda", &lambda, &b_lambda);
   fChain->SetBranchAddress("chisquare_Ebeam", &chisquare_Ebeam, &b_chisquare_Ebeam);
   fChain->SetBranchAddress("chisquare_Ereco", &chisquare_Ereco, &b_chisquare_Ereco);
   Notify();
}
