...
class AnalyzeHGCOctTB : public HGCNtupleVariables{
 ...
 public:
  ...
  float Esum_rechits_EE_Nflag=0;
  float Esum_rechits_EE_Nchannels=0;
  float Esum_rechits_EE_NchannelsLayer1=0;
  float Esum_rechits_EE_noiseflag0=0;
  ...
  TH1F* h_SEnergy_Rechits_EE_Nflag;
  TH1F* h_SEnergy_Rechits_EE_Nchannel;
  TH1F* h_SEnergy_Rechits_EE_NchannelWlayer1;
  ...
  TH1F* h_totalrechits_Nflag;
  TH1F* h_totalrechits_Nchannel;
  TH1F* h_totalrechits_NchannelWlayer1;
  TH1F* h_SEnergy_Rechits_EE_noiseflag0;
  TH1F* h_totalrechits_noiseflag0;
};
#endif
...
void AnalyzeHGCOctTB::BookHistogram(const char *outFileName, const char* conf,  const char* energy) {
  ...
  h_SEnergy_Rechits_EE_Nflag=new TH1F("h_SEnergy_Rechits_EE_Nflag","h_SEnergy_Rechits_EE_Nflag",xbin,xlow,xhigh);
  h_SEnergy_Rechits_EE_Nchannel=new TH1F("h_SEnergy_Rechits_EE_Nchannel","h_SEnergy_Rechits_EE_Nchannel",xbin,xlow,xhigh);
  h_SEnergy_Rechits_EE_NchannelWlayer1=new TH1F("h_SEnergy_Rechits_EE_NchannelWlayer1","h_SEnergy_Rechits_EE_NchannelWlayer1",xbin,xlow,xhigh);
 h_SEnergy_Rechits_EE=new TH1F("h_SEnergy_Rechits_EE","h_SEnergy_Rechits_EE",xbin,xlow,xhigh);
  h_SEnergy_Rechits_EE_noiseflag0= new TH1F("h_SEnergy_Rechits_EE_noiseflag0","h_SEnergy_Rechits_EE_noiseflag0",xbin,xlow,xhigh);
  ...
  h_totalrechits_Nflag=new TH1F("h_totalrechits_Nflag","h_totalrechits_Nflag",1000,0,5000);
  h_totalrechits_Nchannel=new TH1F("h_totalrechits_Nchannel","h_totalrechits_Nchannel",1000,0,5000);
  h_totalrechits_NchannelWlayer1=new TH1F("h_totalrechits_NchannelWlayer1","h_totalrechits_NchannelWlayer1",1000,0,5000);
  h_totalrechits_noiseflag0=new TH1F("h_totalrechits_noiseflag0","h_totalrechits_noiseflag0",1000,0,5000);
}
