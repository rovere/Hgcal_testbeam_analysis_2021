...
void AnalyzeHGCOctTB::EventLoop(const char *data, const char *energy) {
 ...
 float ee_rescaling = 1.035;
  ...
  int ahcal_layer[10]= {43,47,51,55,59,63,67,71,75,79}; //selected layers (10 in total) out of AHCAL (39 in total)
  ...
  for (jentry=0; jentry<nentries;jentry++,hgc_jentry++)
  {
	...
	cout << 10 * k << " %" << endl;
	  ...
	  else if((comb_rechit_z_trimAhcal->at(i)>54) && (comb_rechit_z_trimAhcal->at(i)<154)) //Selecting FH rechits
	    {
