...
class AnalyzeHGCOctTB : public HGCNtupleVariables{
 ...
 public:
  ...
  TH1F* h_SumRechits_EE;
  TH1F* h_SumRechits_FH;
  TH1F* h_SumRechits_AH;
};
#endif
...
void AnalyzeHGCOctTB::BookHistogram(const char *outFileName, const char* conf,  const char* energy) {
  ...
  h_rechit_layer= new TH1F("h_rechit_layer","h_rechit_layer",80,0,80);
  
  h_SumRechits_AH=new TH1F("h_SumRechits_AH","h_SumRechits_AH",500,0,5000);
  h_SumRechits_FH=new TH1F("h_SumRechits_FH","h_SumRechits_FH",500,0,5000);
  h_SumRechits_EE=new TH1F("h_SumRechits_EE","h_SumRechits_EE",500,0,5000);
